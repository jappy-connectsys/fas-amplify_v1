...
import { createCustomer, selectCustomers, selectCustomerId } from './../../../../store/reducers/customerSlice';
...
const CustomerAdd = () => {
  ...
  const [pcountry_code, setPCountryCode] = useState('');
  ...
  <CRow>
    <CCol xs={12}>
      <CCard className="mb-4">
        <CCardHeader>
          <strong>ADD CUSTOMER</strong> <small></small>
        </CCardHeader>
        <CCardBody>
